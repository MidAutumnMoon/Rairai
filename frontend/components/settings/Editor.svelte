...
<div class="sub-detail">
    <header class="sub-detail-head">
        <span class="sub-detail-title"
            >{isEdit ? "Edit assistant" : "New assistant"}</span
        >
    ...
    <div class="sub-detail-body">
        <div class="sub-detail-inner">
            ...
            {#if !providerId}
                <p class="note">
                    No provider bound. This assistant can't run until you pick a
                    model.
                </p>
            {/if}
            ...
            <div class="field">
                <span class="lbl">
                    Prompt blocks
                    <span class="hint">
                        ordered; system → system prompt, user/assistant →
                        messages around the history marker
                    </span>
                </span>
                <div class="pblocks">
                ...
                <div class="pblock-add">
                    <button
                        type="button"
                        class="btn btn-sm"
                        onclick={() => addBlock("system")}>+ System</button
                    >
                    <button
                        type="button"
                        class="btn btn-sm"
                        onclick={() => addBlock("user")}>+ User</button
                    >
                    <button
                        type="button"
                        class="btn btn-sm"
                    ...
                    <button
                        type="button"
                        class="btn btn-sm"
                        onclick={() => addBlock("history")}
                        >+ History marker</button
                    >
                </div>
            </div>
