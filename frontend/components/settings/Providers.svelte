...
<div class="settings-split">
    ...
    <div class="sub-detail">
        ...
        {:else if isNew}
            ...
            <div class="sub-detail-body">
                <div class="sub-detail-inner">
                    ...
                    />
                    <p class="note">
                        After saving, use "Fetch from API" in the model list to
        ...
        {:else if selected}
            <header class="sub-detail-head">
                ...
                <div class="head-actions">
                    ...
                    {#if !selected.enabled}<span class="tag dim">disabled</span
                        >{/if}
                    <button
                        class="btn btn-sm"
                    ...
                    <button class="btn btn-sm" onclick={() => testP(selected)}
                        >Test</button
                    >
                    <button
                        class="btn btn-sm btn-danger"
                        onclick={() => removeProvider(selected)}
                    >
                        Delete
                    </button>
                </div>
        ...
        {:else}
            <div class="sub-detail-body">
                <div class="sub-detail-inner">
                    <div class="empty">Select a provider or add a new one.</div>
                </div>
            </div>
        {/if}
        {#if error}
